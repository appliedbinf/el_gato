...
be found in the log file generated by el_gato. While a key to the abbreviation is found on the Abbreviation Overview page. \
"""
...
def main():
	...
	pdf.ln(5)
	pdf.set_font(style="BU")
	pdf.cell(w=0,h=0, text="Abbreviation Overview", new_x="LMARGIN", new_y="NEXT")
	pdf.ln(15)
	pdf.set_font(style="U")
	...
	pdf.ln(15)
	pdf.set_font(style="U")
	pdf.cell(w=0,h=0, text="mompS Primer Key", new_x="LMARGIN", new_y="NEXT")
	pdf.ln(5)
	pdf.set_font()
